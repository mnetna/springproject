...
<head>
    ...
    <link href="vendor/bootstrap/css/login-register.css" rel="stylesheet"/>
    <link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">

    <script src="vendor/bootstrap/js/jquery-1.10.2.js" type="text/javascript"></script>
    <script src="vendor/bootstrap/js/bootstrap.js" type="text/javascript"></script>
    <script src="vendor/bootstrap/js/login-register.js" type="text/javascript"></script>
